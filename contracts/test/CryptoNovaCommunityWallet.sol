// ─────────────────────────────────────────────────────────────────────────────
//  TEST FIXTURE ONLY — NOT DEPLOYED. NOT PRODUCTION. DO NOT AUDIT AS LIVE CODE.
//
//  The PRODUCTION community wallet is contracts/CommunityWallet.sol
//  (COHORT_SIZE = 500, MAX_MEMBERS = 1000, genesisBps 6000 / pioneerBps 4000),
//  and that is what scripts/deploy_v8.js deploys.
//
//  This file carries TEST-MODE constants (e.g. TRANCHE_A_MAX = 10) and exists
//  only for test/V8_44_Keeper.test.js, which does
//  getContractFactory("CryptoNovaCommunityWallet").
//
//  History: on 2026-08-07 a frontend copy audit read THIS file instead of the
//  deployed one and reported the website's 500/500 + 60/40 split as wrong.
//  The website was correct all along. Moved here 2026-08-08 so the mistake
//  cannot repeat. Do not move it out of contracts/test/ — Hardhat resolves the
//  factory by contract name, so the test still finds it here.
// ─────────────────────────────────────────────────────────────────────────────
