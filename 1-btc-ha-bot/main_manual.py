"""
main_manual.py — BTC HA Bot V3 (Manual Trade Manager)

HOW TO USE
----------
1. Open a trade manually on BTCUSD in MT5 (any direction, any size).
...
-------------------------
  ...
  - Logs every closed trade to btc_trade_log.csv
...
def run():
    print("=" * 55)
    print("  BTC HA BOT V3 — MANUAL TRADE MANAGER")
    ...
    try:
        while True:
            try:
                ...
                if count == 0:
                    print("   Waiting for a manual trade to appear on BTCUSD...")
