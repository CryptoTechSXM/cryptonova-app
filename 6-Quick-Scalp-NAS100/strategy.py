...
def validate_liquidity_candle(box_high, box_low, daily_atr, min_pct=0.20, max_pct=0.35):
    """
    Opening range must be 20-35% of the 14-period daily ATR.
    Below 20% = dead open, above 35% = too explosive to trade.
    """
