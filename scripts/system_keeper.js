 ...
 *   ADDRESSES_FILE           Path to deployed addresses JSON  (default: deployed_addresses_v8_12.json)
...
const ADDR_FILE      = path.join(__dirname, process.env.ADDRESSES_FILE || 'deployed_addresses_v8_12.json');
