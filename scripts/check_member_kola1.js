...
// ── Kola wallet 1 — member count mismatch / emoji / MetaMask TX ──
const WALLET = '0xafa21bb205fc3294d7bc129897889b40ba8b155e';
...
async function main() {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`  Kola Wallet 1 diagnostic — V8.30`);
  console.log(`  ${WALLET}`);
